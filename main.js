let volunteer_list = [
  {
    ...
    requirements: [
      ...
      "Must be at least 18",
      "Training",
      "Very Flexible, any support is appreciated",
    ],
  },
  {
    id: 1,
    ...
    mission: "Our mission is to ...",
    description: "This is non-profit org which works with Pet experts",
    cause_areas: ["Advocacy", "Community"],
    skills: ["Communication", "People Skills", "Social Work"],
    good_for: "Group",
  ...
  },
  {
    ...
    mission:
      "Committed to building strong, inclusive communities while also minimizing waste and promoting sustainability",
    description:
  ...
  },
  {
    ...
    mission:
      "Our mission is to reduce the instances of dog fighting rings to zero and rescue and rehabilitate dogs.",
    description:
